...
function Sidebar() {
    return (
        <div className="flex flex-col items-center md:w-56 w-max h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
            ...
            <a aria-disabled className="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-700 hover:text-gray-300" href="#">
                ...
                <span className="ml-2 text-sm font-medium md:inline hidden">Account</span>
            </a>
        </div>
