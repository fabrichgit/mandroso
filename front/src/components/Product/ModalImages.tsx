...
function ModalImages({ images, onClose }: { images: string[], onClose: () => void }) {
    return (
        <div className="absolute flex justify-center items-center w-screen h-screen left-0 top-0 bg-black/70 overflow-y-auto">
            <div className="bg-white p-6 md:rounded-2xl md:shadow-2xl modal-field my-modal relative">
                ...
                <div className="flex flex-nowrap gap-5 h-max w-full overflow-x-auto p-5">
                    {
                        images.map(url => (
                            <div className="min-w-[30%] h-max p-4 rounded-lg bg-gray-100">
