...
func AddRecette(w http.ResponseWriter, r *http.Request) {
	...
	collection, ctx, cancel := database.Collection(w, "recette")
...
func GetRecette(w http.ResponseWriter, r *http.Request) {
	recette, err := helper.GetRecette(w)
...
func UpdateValidR(w http.ResponseWriter, r *http.Request) {
	// (w).Header().Set("Access-Control-Allow-Origin", os.Getenv("ORIGIN_URL"))
...
func UpdateNatureR(w http.ResponseWriter, r *http.Request) {
	// (w).Header().Set("Access-Control-Allow-Origin", os.Getenv("ORIGIN_URL"))
...
func UpdateTresorR(w http.ResponseWriter, r *http.Request) {
	claims, ok := r.Context().Value("jwtClaims").(*jwt.MapClaims)
	if !ok {
		http.Error(w, "failed to get claims", http.StatusInternalServerError)
		return
